...
criptos = [#'ABEV3.SA','ALOS3.SA','ARZZ3.SA','ASAI3.SA','AZUL4.SA','B3SA3.SA','BBAS3.SA','BBDC3.SA','BBDC4.SA','BBSE3.SA','BEEF3.SA','BHIA3.SA','BOVA11.SA','BPAC11.SA','BRAP4.SA','BRFS3.SA','BRKM5.SA','CCRO3.SA',
#  'CIEL3.SA', 'CMIG4.SA', 'CMIN3.SA', 'COGN3.SA', 'CPLE6.SA', 'CSAN3.SA', 'CSNA3.SA', 'CVCB3.SA', 'CXSE3.SA', 'CYRE3.SA', 'EGIE3.SA', 'ELET3.SA', 'ELET6.SA', 'EMBR3.SA', 'ENAT3.SA', 'EQTL3.SA', 'FLRY3.SA', 'GFSA3.SA', 'GGBR4.SA', 'GOAU4.SA', 'HAPV3.SA', 'HYPE3.SA', 'IGTI11.SA', 'IRBR3.SA', 'ITSA4.SA', 'ITUB4.SA', 'JBSS3.SA', 'KLBN11.SA', 'LEVE3.SA', 'LREN3.SA', 'LWSA3.SA', 'MGLU3.SA', 'MRFG3.SA', 'MRVE3.SA', 'MULT3.SA', 'NTCO3.SA', 'PCAR3.SA', 'PETR3.SA',
#            'PETR4.SA','PETZ3.SA','PRIO3.SA','PSSA3.SA','QUAL3.SA','RADL3.SA','RAIL3.SA','RAIZ4.SA','RDOR3.SA','RENT3.SA','RRRP3.SA','SANB11.SA','SBSP3.SA','SEER3.SA','SMAL11.SA','SOMA3.SA','SUZB3.SA','TAEE11.SA','TIMS3.SA','TOTS3.SA','UGPA3.SA','USIM5.SA','VALE3.SA','VBBR3.SA','WEGE3.SA','YDUQ3.SA','BBSE3.SA',
#     "BTC-USD", "ETH-USD", "BNB-USD", "XRP-USD", "ADA-USD",
#     "DOGE-USD", "DOT1-USD", "UNI3-USD", "BCH-USD", "LTC-USD",
#     "SOL1-USD", "LINK-USD", "MATIC-USD", "ICP1-USD", "XLM-USD",
...
#     "REN-USD", "OKB-USD", "BTT-USD", "FLOW-USD", "RVN-USD",
    "LTC-USD", 'LINK-USD', 'SOL-USD', 'AAVE-USD', 'XLM-USD','ARB-USD','OP-USD', 'NCN-USD'
...
for ativo in ativos:
    ...
    axs[0].title.set_text('Preço de Fechamento, Médias Móveis, Estocástico e Sinais')
...
# Corpo do e-mail
body = f"""
Lista de Ativos Bons para Compra: {bons_para_compra}
Lista de Ativos Bons para Venda: {bons_para_venda}
"""
